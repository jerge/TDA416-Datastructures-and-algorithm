...
/**
 * This is a specialized double linked list for removing points in small
 * figures. It is not circular, the leftmost node has a null left pointer and
 * the rigthmost node has a null right pointer The nodes store a left and a
 * right pointer and the nodes importance.
 */
public class DLList {
	...
	// ============================================================
	/**
	 * Creates a list from user input (or file by redirection). Format should be two
	 * integer points per line separated by space x y
	 * 
	...
	private static double importanceOfP(Point l, Point p, Point r) {
		...
		/*
		 * debug System.out.println("punkterna (l: p: r): " + l + ": " + p + ": " + r);
		 * System.out.println("l-p= " + String.format( "%5.2f ", l1) + " p-r= " +
		 * String.format( "%5.2f ", l2) + " l-r= " + String.format( "%5.2f ", l3) +
	...
	// ============================================================
	/**
	 * Returns a simple iterator over the list It is not protected from updates to
	 * the list
	 * 
	...
	/**
	 * Creates a "fake" list from a constant array. can be used for debugging
	 * 
	 * @return the number of points in the list
	 */
